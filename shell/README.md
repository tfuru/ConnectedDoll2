...
| **前面ボタン用吸着ナット** | **M2 六角ナット (JIS規格/スチール製)** | **4個** | **厚み 1.6mm (二面幅 4.0mm)** | ボタン表面の六角ポケット（深さ1.6mm/二面幅4.4mm）に接着・圧入し、アクリル側磁石を吸着 |
...
3. **前面ボタン（ボタンキャップ）**: `scad/front_button.scad`
   - 側面操作用大型ボタン（ズレ防止ガイド長2.5mm＋抜け止めツバ1.2mm、操作面 M2 六角ナット直接接着ポケット、スイッチ押下プランジャー付き）
   - **マグネット吸着式 アクリル化粧パネル対応**:
     - アクリルパネル四隅に配置した **φ6.0mm × 3.0mm ネオジム磁石** が、ボタン表面の M2 スチール製六角ナットにカチッと強力に吸着する構造。
     - アクリルパネル外寸: **43.2mm × 13.2mm × 厚み 3.0mm**（磁石ピッチ: 34.0mm × 5.5mm）
